let array = [
  {
    ...
    Knausgaard tilde try-hard, woke fixie banjo man bun. Small batch tumeric mustache tbh wayfarers 8-bit shaman chartreuse tacos. 
    Viral direct trade hoodie ugh chambray, craft beer pork belly flannel tacos single-origin coffee art party migas plaid pop-up.`,
  },
  {
    id: 2,
    title: "Vision",
...
const visionLi = document.getElementById("vision");
const goalsLi = document.getElementById("goals");
const textInfo = document.getElementById("info-text-p");

historyLi.style.backgroundColor = "white";
textInfo.textContent = array[0].content;
historyLi.addEventListener("click", () => {
  historyLi.style.backgroundColor = "white";
  textInfo.textContent = array[0].content;
  visionLi.style.backgroundColor = "gray";
  goalsLi.style.backgroundColor = "gray";
});
visionLi.addEventListener("click", () => {
    visionLi.style.backgroundColor = "white";
    textInfo.textContent = array[1].content;
    historyLi.style.backgroundColor = "gray";
    goalsLi.style.backgroundColor = "gray";
});
goalsLi.addEventListener("click", () => {
    goalsLi.style.backgroundColor = "white";
    textInfo.textContent = array[2].content;
    visionLi.style.backgroundColor = "gray";
    historyLi.style.backgroundColor = "gray";
});
